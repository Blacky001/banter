...
# Form implementation generated from reading ui file 'Desktop/banter1/trunk/banter/Server/server.ui'
#
# Created: Fri Sep 17 17:54:02 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listWidget.setStyleSheet("background-color: qlineargradient(spread:repeat, x1:0, y1:0, x2:1, y2:0, stop:1 rgba(74, 133, 181, 255));")
        self.listWidget.setObjectName("listWidget")
        self.listWidget_2 = QtGui.QListWidget(self.centralwidget)
        self.listWidget_2.setGeometry(QtCore.QRect(160, 0, 431, 481))
        self.listWidget_2.setStyleSheet("background-color: qlineargradient(spread:repeat, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(74, 133, 181, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.actionSend_message_to = QtGui.QAction(MainWindow)
        self.actionSend_message_to.setObjectName("actionSend_message_to")
        ...
        self.menuUsers.addAction(self.actionSend_message_to)
        ...
        self.menuChat.addAction(self.actionStart)
        self.menuChat.addAction(self.actionRestart)
        self.menuChat.addAction(self.actionStop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSend_message_to.setText(QtGui.QApplication.translate("MainWindow", "send message to", None, QtGui.QApplication.UnicodeUTF8))
